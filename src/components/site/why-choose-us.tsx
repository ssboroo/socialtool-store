...
const CARDS = [
  {
    ...
    desc: 'Төлбөр баталгаажсаны дараа захиалгыг боловсруулна. Хүргэлт, идэвхжүүлэлтийн хугацааг бүтээгдэхүүний тайлбараас харна уу.',
  ...
  },
  {
    ...
    desc: 'QPay төлбөрийн хуудсан дээрх QR кодыг банкны апп-аараа уншуулж төлнө.',
  ...
  },
  {
    ...
    desc: 'Баталгаа, солих болон буцаах нөхцөлийг тухайн бүтээгдэхүүний тайлбараас шалгана уу.',
    color: 'from-[#8B5CF6] to-[#1677FF]',
    bg: 'bg-[#F0EAFF]',
  },
  {
    Icon: Headphones,
    title: 'Хэрэглэгчийн тусламж',
    desc: 'Асуух зүйл байвал сайтын чат эсвэл Telegram-аар бидэнтэй холбогдоорой.',
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="mt-4 text-3xl sm:text-4xl font-extrabold tracking-tight text-[#102A43]">
            Үйлчлүүлэгчид бидэнд <span className="gradient-text">итгэдэг</span>
          </h2>
          <p className="mt-3 text-[#5B7290]">
            Сонголт хийхээс эхлээд захиалгаа авах хүртэл танд тусална.
          </p>
        </div>
