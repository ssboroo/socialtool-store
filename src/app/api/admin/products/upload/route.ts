...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    try {
      ...
      return NextResponse.json(
        { error: 'Зургийг уншиж чадсангүй. Хүчинтэй JPEG, PNG, WebP эсвэл GIF файл сонгоно уу.' },
        { status: 400 },
      )
    }
    ...
    await db.uploadedImage.create({
      data: { filename, mimeType: 'image/webp', bytes: new Uint8Array(bytes) },
    })
    ...
    return NextResponse.json(
      { error: 'Зураг хадгалагдсангүй. Өгөгдлийн сангийн UploadedImage шинэчлэл болон холболтыг шалгана уу.' },
      { status: 503 },
    )
  }
}
